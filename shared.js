...
function buildPrintChunks(result) {
  ...
  const contentBlocks = isMono
    ? [["Source Text", data.source], ["Translation A - " + data.targetA.heading, data.targetA.content], ["Translation B - " + data.targetB.heading, data.targetB.content]]
    : [["Source Text", data.source], ["Target A - " + data.targetA.heading, data.targetA.content], ["Target B - " + data.targetB.heading, data.targetB.content]];
