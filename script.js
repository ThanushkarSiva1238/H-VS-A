...
(function () {
  ...
  function buildChallenge() {
    ...
    if (state.mode === "monolingual") {
      ...
      const direction = state.langSource === "en" ? "en" : "ta";
      const c = d.mono[direction];
      blocksEl.innerHTML = `
        ...
        <div class="text-blocks grid-2" style="margin-top:0;">
          <div class="text-block"><span class="text-block__label">Translation A</span><div class="text-block__body">${c.targetA.content}</div></div>
          <div class="text-block"><span class="text-block__label">Translation B</span><div class="text-block__body">${c.targetB.content}</div></div>
        </div>  
      `;
    } else {
      blocksEl.classList.remove("grid-2");
      ...
      blocksEl.innerHTML = `
        <div class="text-block text-block--source"><span class="text-block__label">Source Text</span><div class="text-block__body">${c.source}</div></div>
        <div class="text-blocks grid-2" style="margin-top:0;">
          <div class="text-block"><span class="text-block__label">Target A</span><div class="text-block__body">${c.targetA.content}</div></div>
          <div class="text-block"><span class="text-block__label">Target B</span><div class="text-block__body">${c.targetB.content}</div></div>
        </div>
      `;
    }
  ...
  function buildExplanation() {
    ...
    if (state.mode === "monolingual") {
      ...
      blocksEl.innerHTML = `
        <div class="text-block text-block--source"><span class="text-block__label">Source Text</span><div class="text-block__body">${c.source}</div></div>
        <div class="text-blocks grid-2" style="margin-top:0;">
          <div class="text-block"><span class="text-block__label">${c.targetA.heading} Translation</span><div class="text-block__body">${c.targetA.content}</div></div>
          <div class="text-block"><span class="text-block__label">${c.targetB.heading} Translation</span><div class="text-block__body">${c.targetB.content}</div></div>
        </div>
      `;
      ...
      blocksEl.innerHTML = `
        <div class="text-block text-block--source"><span class="text-block__label">Source Text</span><div class="text-block__body">${c.source}</div></div>
        <div class="text-blocks grid-2" style="margin-top:0;">
          <div class="text-block"><span class="text-block__label">${c.targetA.heading} Target Text</span><div class="text-block__body">${c.targetA.content}</div></div>
          <div class="text-block"><span class="text-block__label">${c.targetB.heading} Target Text</span><div class="text-block__body">${c.targetB.content}</div></div>
        </div>
      `;
      if (state.langSource === "en") {
