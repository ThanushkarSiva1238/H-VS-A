...
const DUNGEONS = {
  ...
  technical: {
    ...
    explanationMono:
    {
      ...
      ta:"The AI version difficult to understand because terms such as [[\"மூல இடம்,\" \"ஒயர்,\" \"இலக்கு,\" \"தொடக்கக் காலத் தகவல்,\" and \"தொழில்நிகழ்வு\"||Terminologies choosed by AI]] were unfamiliar to general readers. The AI also used \"தகவல்\" where [[\"தரவு\"||Corrected]] was more appropriate for the technical context. Therefore, we choose \"தரவு\" because it specifically refers to data in the technical domain. Based on the [[target audience’s feedback||Collected Data from Target Audience]], the human version was clearer and easier to understand than the AI version."
    },
